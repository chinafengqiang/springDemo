...
public class MQConfig {
	...
	public static final String FANOUT_EXCHANGE_TEST = "fanoutxchagetest";
	/**
	...
	@Bean
	public FanoutExchange fanoutxchageTest(){
	...
	public Binding FanoutBinding3() {
		return BindingBuilder.bind(topicQueue3()).to(fanoutxchageTest());
	}
